...
Window
{
    ...
    JSONmanager {
        ...
        onProfileSet: (profile) => {
            root.driverNum = profile
        }

        onBrakeBiasSet: (bias) => {
            root.frontBrakeBias = bias
            root.rearBrakeBias = 100 - bias
        }

        onTractionSet: (value) => {
            root.tractionNum = value
        }
